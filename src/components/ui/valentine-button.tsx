...
const valentineButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-lg font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none touch-manipulation",
  {
    variants: {
      variant: {
        yes: "bg-gradient-to-br from-primary to-valentine-rose-deep text-primary-foreground shadow-button hover:shadow-float hover:scale-105 active:scale-95 transition-all duration-300",
        no: "bg-gradient-to-br from-muted to-valentine-rose-light text-foreground shadow-valentine hover:shadow-button border border-border/50",
        soft: "bg-secondary text-secondary-foreground shadow-valentine hover:bg-accent hover:text-accent-foreground hover:scale-105 active:scale-95 transition-all duration-300",
        chaos: "bg-gradient-to-br from-valentine-chaos-pink to-valentine-chaos-purple text-white shadow-button animate-wiggle border-2 border-white/20",
        celebration: "bg-gradient-to-br from-valentine-gold to-valentine-coral text-white shadow-float hover:scale-105 active:scale-95 animate-glow-pulse",
